		...
		questionRepository.saveAll(
			List.of(
				Question.builder()
					...
					.questionType("dfs")
					.title("title-1")
					.url("http://localhost/leetcode/url/1")
					.fromSource("백준")
					.reviewCount(4)
					.userInfo(user1)
					.build(),
				Question.builder()
					...
					.questionType("bfs")
					.title("미로찾기-2")
					.url("http://localhost/leetcode/url/2")
					.fromSource("백준")
					.reviewCount(0)
					.userInfo(user1)
					.build(),
				Question.builder()
					...
					.questionType("greedy")
					.title("title-3")
					.url("http://localhost/leetcode/url/3")
					.fromSource("백준")
					.reviewCount(0)
					.userInfo(user1)
					.build(),
				Question.builder()
					...
					.questionType("greedy")
					.title("title-4")
					.url("http://localhost/leetcode/url/4")
					.fromSource("백준")
					.reviewCount(0)
					.userInfo(user2)
					.build(),
				Question.builder()
					...
					.questionType("dp")
					.title("title-5")
					.url("http://localhost/leetcode/url/5")
					.fromSource("leetcode")
					.reviewCount(0)
					.userInfo(user2)
					.build(),
				Question.builder()
					...
					.questionType("bfs")
					.title("title-6")
					.url("http://localhost/leetcode/url/6")
					.fromSource("leetcode")
					.reviewCount(0)
					.userInfo(user2)
					.build()
		...
		Iterable<Question> questions = questionRepository.saveAll(
			List.of(
				...
				Question.builder()
					...
					.questionType("bfs")
					.title("title-7")
					.url("http://localhost/leetcode/url/7")
					.fromSource("leetcode")
					.reviewCount(0)
					.userInfo(user3)
					.build()
